        ...
        <div className="flex items-start gap-2 ">
          ...
          <div className="w-3/4 md:w-7/12 flex flex-col gap-1">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className=" md:hidden flex items-center gap-2 text-zomato_red  border border-zomato_font px-2 py-1 rounded-lg"
              >
                {food.isAddedToCart ? (
                  "Added"
                ) : (
          ...
          <div className="hidden md:block w-2/12	">
            <button
              onClick={addFoodToCart}
              disabled={food.isAddedToCart}
              className=" flex items-center gap-2 text-zomato_red  border border-zomato_font px-4 py-2 rounded-lg"
            >
              {food.isAddedToCart ? (
                "Added"
              ) : (
